 ...
 */
std::list<Type *> *FuncType::getArgList(void) { return arglist; }
 ...
 */
size_t FuncType::numOfParameters(void) { return arglist->size(); }
 ...
 */
void FuncType::appendParameter(Type *t) { arglist->push_back(t); }
